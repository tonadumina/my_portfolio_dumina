...
.light {
      width: 200px;
    height: 0px;
    border-bottom: 900px solid rgb(44 255 255 / 54%);
...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <h1 class="message__title">УПС</h1>
      <p class="message__text">Теста на эту страницу еще не создан</p>
    </div>
